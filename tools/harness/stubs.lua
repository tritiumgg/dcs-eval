...
t.eq(hook.lfs.attributes(box .. "\\a\\b", "mode"), "directory", "a directory holding an open file is still a directory")
t.eq(hook.lfs.attributes(box, "mode"), "directory", "and so is one holding it further down")
t.eq(hook.lfs.attributes([[C:\Users]], "mode"), "directory", "a directory the user may not rename is a directory")
held:close()
