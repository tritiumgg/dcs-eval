...
- note: the report still opens `not verified:`, and only the exit code
  lies, which is the defect for a script or an agent that reads the code,
  as T52 and T51 are run.
