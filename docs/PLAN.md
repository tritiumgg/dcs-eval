...
supervisor, in turn in one session, a read that stops the run retested alone in a fresh one (ADR
0028), and the result recorded). Neither blocks Milestones A–C.
