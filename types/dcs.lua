...
--------------------------------------------------------------------------------
-- The mission state's `a_do_script`
--------------------------------------------------------------------------------

--- Run a chunk in the mission scripting environment, from the `mission` state.
--- The second of the two hops into `missionscripting`; nil with no mission
--- loaded. The arguments after `code` reach the chunk as `...`, and what
--- the chunk returns comes back shifted by one: `v1 … vN` as
--- `nil, v1 … v(N-1)`.
---@param code string
---@param ... any
---@return any ...
